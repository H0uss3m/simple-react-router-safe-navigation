...
export default function Detail () {
  return (
      <>
        <p>
          <strong>Qu'est-ce que le Lorem Ipsum?</strong> <br />
          ...
          <br /> On sait depuis longtemps que travailler avec du texte lisible
          ...
          <br /> <strong>D'où vient-il?</strong>
          <br /> Contrairement à une opinion répandue, le Lorem Ipsum n'est pas
          ...
          <br />
          <strong>Où puis-je m'en procurer? </strong>
          <br />
